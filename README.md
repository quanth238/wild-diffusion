...
## 6) Stage A Resume Full-State (40k -> +20 MIMG)
- Use this exact runbook for supervisor-style screening with full-state resume:
  `docs/README_stageA_resume_full_state_40k.md`
- It includes:
  - fixed anchor paths:
    `/mnt/data/quanth/models/warm_up_wild_diffusion_with_20_data/{training-state-040000.pt,network-snapshot-040000.pkl}`,
  - how to resume from `training-state-040000.pt`,
  - how to run official FID-50k evaluation after continuation.
