...
CDRO_MARKOV_DEFAULTS = {
    ...
    "disable_control_after_stop": False,
    "score_steps": 8,
    ...
    "budget_utilization_patience": 0,
    "budget_utilization_start_epoch": 0,
    "max_budget_utilization": 0.0,
    "high_budget_utilization_patience": 0,
    "high_budget_utilization_start_epoch": 0,
