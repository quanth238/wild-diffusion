...
OUTDIR="${OUTDIR:-${ROOT_DIR}/toy_outputs/simpsons5_cdro_400k_warmup20_rho32_n032_cw0_aw100_perex_default}"
PREFIX_ROOT="${PREFIX_ROOT:-simpsons5_cdro_400k_warmup20_rho32_n032_i1_aw100_cw000_perex_default}"
