...
TRAIN_OUTROOT="${TRAIN_OUTROOT:-${ROOT_DIR}/training-runs/paper-cifar10-cdro-fp16-rho0-lr1e6-baseline80k_${CAMPAIGN_TAG}}"
EVAL_SWEEP_ROOT="${EVAL_SWEEP_ROOT:-${ROOT_DIR}/training-runs/fid-sweeps/cdro_rho0_lr1e6_n004_baseline80k_${CAMPAIGN_TAG}}"
