...
TRAIN_OUTROOT_BASE="${TRAIN_OUTROOT_BASE:-${ROOT_DIR}/training-runs/paper-cifar10-cdro-fp16-n004-rho-bracket50k_${CAMPAIGN_TAG}}"
EVAL_SWEEP_ROOT_BASE="${EVAL_SWEEP_ROOT_BASE:-${ROOT_DIR}/training-runs/fid-sweeps/cdro_n004_rho_bracket50k_${CAMPAIGN_TAG}}"
